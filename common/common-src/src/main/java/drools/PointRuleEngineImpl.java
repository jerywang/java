...
/**
 * PointRuleEngineImpl.java 八月 11,2017 wangguoxing@baidu.com
 */
public class PointRuleEngineImpl implements PointRuleEngine {
    ...
    private List<String> getTestDrlFile() {
        String path = PointRuleEngineImpl.class.getResource("").getPath();
        List<String> drlFilePath = new ArrayList<String>();
        drlFilePath
                .add(path + "addpoint.drl");
        drlFilePath
                .add(path + "subpoint.drl");
